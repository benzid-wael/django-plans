...
class Plan(models.Model):
    ...
    def get_default_plan(cls):
        """
        Returns the defined default plan in settings or the recent default
        plan.
        """
...
class BillingInfo(models.Model):
    ...
    shipping_street = models.CharField(
        _('Street (shipping)'), max_length=200, blank=True,
        help_text=_('optional')
    )
    shipping_zipcode = models.CharField(
        _('Zip code (shipping)'), blank=True, max_length=200,
        help_text=_('optional')
    )
...
class UserVault(models.Model):
    ...
    token = models.CharField(
        _('Token'), max_length=10, editable=False,
...
class PaymentLog(models.Model):
    ...
    def __str__(self):
        return (
            '%s charged %s %s - %s' % (
                self.user, self.amount, self.currency, self.transaction_id
            )
        )
